...
import { Loader2, Save, User, Settings, Bell, Moon, Sun } from 'lucide-react';
    ...
    return (
        <Layout>
            <div className="container mx-auto py-8 px-4 max-w-4xl animate-in fade-in duration-500">
                <h1 className="text-3xl font-bold mb-8 text-primary-900 dark:text-white">Configuración de Usuario</h1>
                            ...
                            {activeTab === 'profile' && (
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>Visualiza tu información personal básica.</CardDescription>
                                    </CardHeader>
                                    <CardContent className="space-y-4">
                                        <div className="grid gap-2">
                                            <label className="text-sm font-medium">Nombre Completo</label>
                                            <Input value={user?.name || ''} disabled className="bg-slate-50 dark:bg-slate-900" />
                                            <p className="text-xs text-muted-foreground">El nombre es administrado por el sistema de autenticación.</p>
                                        </div>
                                        <div className="grid gap-2">
                            ...
                            {activeTab === 'preferences' && (
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>Personaliza tu experiencia en SIMAUD-LEX.</CardDescription>
                                    </CardHeader>
                            ...
                            {activeTab === 'notifications' && (
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>Administra cómo deseas recibir alertas.</CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        <div className="flex items-center justify-between space-x-2 border p-4 rounded-lg">
                                            <div className="flex flex-col space-y-1">
                                                <span className="font-medium">Notificaciones del Sistema</span>
                                                <span className="text-sm text-muted-foreground">Recibir alertas sobre actualizaciones de casos y sistema.</span>
                                            </div>
                                            <input 
                                                type="checkbox" 
