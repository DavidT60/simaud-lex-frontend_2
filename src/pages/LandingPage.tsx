          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <p className="mx-auto max-w-[700px] text-gray-300 md:text-xl">
                SIMAUD-LEX revoluciona la gestión judicial mediante inteligencia
                artificial avanzada. Simulación de sentencias, análisis de casos
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">
                Herramientas diseñadas específicamente para optimizar el flujo
                de trabajo en juzgados y despachos.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid gap-8 md:grid-cols-4 text-center">
            <div className="space-y-4 flex flex-col items-center">
              ...
              <p className="text-sm">
                Redefiniendo el futuro de la justicia con tecnología de
                vanguardia.
              </p>
            </div>
...
const CustomSection = () => {
  ...
  const customData = {
    ...
    content:
      "En SIMAUD-LEX nos comprometemos a brindar transparencia, celeridad y precisión en cada proceso judicial. Nuestra plataforma integra las mejores prácticas legales con la potencia del cómputo moderno.",
    items: [
      {
        id: 1,
        title: "Innovación Constante",
        text: "Actualizaciones semanales con nuevas reglas y jurisprudencia.",
      },
      {
        id: 2,
        title: "Soporte Especializado",
        text: "Equipo legal y técnico disponible 24/7.",
      },
      {
        id: 3,
        title: "Ética y Privacidad",
        text: "Estrictos protocolos de manejo ético de la información.",
      },
    ],
  };
        ...
        <div className="flex flex-col items-center text-center space-y-8 max-w-4xl mx-auto">
          ...
          <div className="grid gap-6 mt-8 md:grid-cols-3">
            {customData.items.map((item) => (
              <div
                key={item.id}
                className="flex flex-col items-center gap-2 p-4 rounded-lg bg-slate-50 dark:bg-slate-800/50"
              >
